...
<form class="layui-form layui-inline" action="">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-block">
            <input style="width: 300px" type="text" name="name" required lay-verify="" placeholder="请输入姓名"
    ...
    <div class="layui-form-item layui-inline">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="tea_get">查询</button>
        </div>
    </div>
...
<script type="text/html" id="barDemo">
    ...
    <a style="background: #FF5722;color: white" class="layui-btn layui-btn-primary layui-btn-xs"
...
<script>
    layui.use(['table', 'form', 'laydate', 'layer'], function () {
        ...
        table.render({
            ...
            , toolbar: '#barDemo'
            , height: 600
            , url: 'http://localhost:8081/Servlet_GetTeaByName' //数据接口
            ...
            , loading: true
            , cols: [[ //表头
                {field: 'tid', title: '工号', width: 160, sort: true}

                , {field: 'name', title: '姓名', width: 160}
                , {field: 'tel', title: '电话', width: 160}
                , {field: 'age', title: '年龄', width: 160, sort: true}
                , {field: 't_time', title: '入职时间', width: 160, sort: true}
            ...
            switch (obj.event) {
                ...
                case 'delete':
                    layer.confirm('确认删除该教师', {
                        ...
                        console.log(index)
                        $.ajax({
                            url: "http://localhost:8081/Servlet_DelTea",
                            method: "POST",
                            dataType: "json",
                            data: {
                                tid:obj.data.tid,
        ...
        //   表单提交
        form.on('submit(tea_get)', function (data) {

...
@WebServlet(name = "Servlet_AddTea", value = "/Servlet_AddTea")
public class Servlet_AddTea extends HttpServlet {
    private static final long serialVersionUID = 1L;

    TeacherServiceImp ts;
    public  Servlet_AddTea(){
...
// TODO Auto-generated method stub
        ...
        Teacher t= new Teacher(tid,password,name,tel,age,t_time);

...
@WebServlet(name = "Servlet_StuChangePwd", value = "/Servlet_StuChangePwd")
public class Servlet_StuChangePwd extends HttpServlet {
    private static final long serialVersionUID = 1L;
    StudentServiceImp ss;

    public Servlet_StuChangePwd(){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = ss.ChangePassword(sid,password);

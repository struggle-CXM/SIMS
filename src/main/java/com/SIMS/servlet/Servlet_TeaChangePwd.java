...
@WebServlet(name = "Servlet_TeaChangePwd", value = "/Servlet_TeaChangePwd")
public class Servlet_TeaChangePwd extends HttpServlet {
    private static final long serialVersionUID = 1L;
    TeacherServiceImp ts;

    public Servlet_TeaChangePwd(){
...
// TODO Auto-generated method stub
        ...
        int i = ts.ChangePassword(tid,password);
        Gson json = new Gson();

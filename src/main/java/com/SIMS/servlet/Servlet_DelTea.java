...
@WebServlet(name = "Servlet_DelTea", value = "/Servlet_DelTea")
public class Servlet_DelTea extends HttpServlet {
    private static final long serialVersionUID = 1L;

    TeacherServiceImp ts;
     public Servlet_DelTea(){
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int i = ts.DelTeacher(new Teacher(tid,password));
        Gson json = new Gson();

...
@WebServlet(name = "Servlet_AdmChangePwd", value = "/Servlet_AdmChangePwd")
public class Servlet_AdmChangePwd extends HttpServlet {
    private static final long serialVersionUID = 1L;
    AdminServiceImp as;
    public Servlet_AdmChangePwd(){
...
// TODO Auto-generated method stub
        ...
        int i = as.ChangePassword(new Admin(aid,password));
        Gson json = new Gson();
